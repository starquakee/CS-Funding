...
public interface FundMapper {
    ...
    @Select("select * from fund f join researchgroup_fund rf on rf.Fund_UUID = f.UUID where FundNumber like CONCAT('%', #{FundNumber}, '%') and FundName like CONCAT('%', #{FundName}, '%')")
    List<Fund> getFundVague(@Param("FundNumber") String FundNumber, @Param("FundName") String FundName, @Param("FundName") String researchGroupId);
